...
urlpatterns = [
   ...
   path('view_students_for_subject/<int:subid>/',views.view_students_for_subject,name="view_students_for_subject"),
   path('myassignedsubject/',views.myassignedsubject,name="myassignedsubject"),
   path('view_student_details/<int:sid>/',views.view_student_details,name="view_student_details"),
